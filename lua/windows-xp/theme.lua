...
theme.set_highlights = function()
  ...
  -- hl(0, "CursorLine", { fg = 'NONE', bg = c.window.bg })
  -- hl(0, "CursorColumn", { fg = 'NONE', bg = c.window.bg })
  ...
  hl(0, "DiffAdd", { fg = 'NONE', bg = c.blues.highlight })
  hl(0, "DiffChange", { fg = 'NONE', bg = c.blues.highlight })
