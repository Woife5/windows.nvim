local c = require('windows-xp.palette')
...
theme.set_highlights = function()
  ...
  hl(0, "PmenuSel", { fg = 'NONE', bg = c.blues.highlight })
  hl(0, "WildMenu", { fg = c.fg, bg = c.blues.text_light })
  hl(0, "LineNr", { fg = c.blues.text, bg = c.window.bg })
  hl(0, "CursorLineNr", { fg = c.blues.text_active, bg = 'NONE', bold = true, })
  hl(0, "Folded", { fg = c.grays.dark_text, bg = c.grays.dark_bg })
  hl(0, "FoldColumn", { fg = c.grays.dark_text, bg = c.window.bg })
  hl(0, "FloatBorder", { fg = c.window.border, bg = c.window.bg })
  hl(0, "FloatTitle", { fg = c.blues.text_active, bg = c.window.bg, bold = true })
  hl(0, "Whitespace", { fg = c.grays.light_text, bg = 'NONE' })
  hl(0, "VertSplit", { fg = c.window.border, bg = c.bg })
  hl(0, "CursorLine", { fg = 'NONE', bg = c.blues.highlight })
  hl(0, "CursorColumn", { fg = 'NONE', bg = c.blues.highlight })
  hl(0, "ColorColumn", { fg = 'NONE', bg = c.window.bg })
  hl(0, "NormalFloat", { fg = c.window.fg, bg = c.window.bg })
  hl(0, "Visual", { fg = 'NONE', bg = c.blues.highlight })
  hl(0, "VisualNOS", { fg = 'NONE', bg = c.blues.highlight })
  hl(0, "WarningMsg", { fg = c.warn, bg = c.bg })
  hl(0, "DiffText", { fg = 'NONE', bg = c.blues.highlight })
  hl(0, "DiffAdd", { fg = 'NONE', bg = "#d4edda" })
  hl(0, "DiffChange", { fg = 'NONE', bg = "#fff3cd" })
  hl(0, "DiffDelete", { fg = 'NONE', bg = "#f8d7da" })
  hl(0, "PmenuSbar", { fg = 'NONE', bg = c.grays.dark_bg })
  hl(0, "PmenuThumb", { fg = 'NONE', bg = c.grays.dark_text })
  hl(0, "Cursor", { fg = c.bg, bg = c.fg })
  -- hl(0, "lCursor", { fg = c.bg, bg = c.fg })
  -- hl(0, "iCursor", { fg = c.bg, bg = c.fg })
  -- hl(0, "CursorIM", { fg = c.bg, bg = c.fg })
  -- hl(0, "TermCursor", { fg = c.bg, bg = c.fg })
  -- hl(0, "TermCursorNC", { fg = c.bg, bg = c.fg })
  hl(0, "Conceal", { fg = c.grays.dark_text, bg = 'NONE' })
  hl(0, "Directory", { fg = c.blues.primary, bg = 'NONE' })
  hl(0, "SpecialKey", { fg = c.blues.text_light, bg = 'NONE', bold = true })
  hl(0, "ErrorMsg", { fg = c.reds.error, bg = c.bg, bold = true })
  hl(0, "Search", { fg = 'NONE', bg = c.blues.highlight })
  hl(0, "IncSearch", { fg = 'NONE', bg = c.blues.highlight })
  hl(0, "CurSearch", { fg = 'NONE', bg = c.blues.highlight })
  hl(0, "Substitute", { fg = c.bg, bg = c.select })
  hl(0, "MoreMsg", { fg = c.greens.primary, bg = 'NONE' })
  hl(0, "Question", { fg = c.greens.primary, bg = 'NONE' })
  hl(0, "EndOfBuffer", { fg = c.grays.light_text, bg = 'NONE' })
  hl(0, "NonText", { fg = c.indent_active, bg = 'NONE' })
  hl(0, "TabLine", { fg = c.grays.dark_text, bg = c.grays.dark_bg })
  hl(0, "TabLineSel", { fg = c.fg, bg = c.bg, bold = true })
  hl(0, "TabLineFill", { fg = 'NONE', bg = c.grays.dark_bg })
  ...
  hl(0, "Keyword", { fg = c.tokens.keyword, bg = 'NONE' })
  hl(0, "Conditional", { fg = c.tokens.conditional, bg = 'NONE' })
  ...
  hl(0, "Title", { fg = c.blues.primary, bg = 'NONE', bold = true, })
  -- hl(0, "Label", { fg = c.blues.text_light, bg = 'NONE' })
  -- hl(0, "SpecialChar", { fg = c.dark_yellow, bg = 'NONE' })
  hl(0, "Delimiter", { fg = c.fg, bg = 'NONE' })
  hl(0, "SpecialComment", { fg = c.fg, bg = 'NONE' })
  hl(0, "Tag", { fg = c.blues.text_light, bg = 'NONE' })
  hl(0, "Bold", { fg = c.blues.text_light, bg = 'NONE', bold = true, })
  ...
  -- QuickFix
  hl(0, "QuickFixLine", { fg = 'NONE', bg = c.blues.highlight })
  hl(0, "qfSeparator", { fg = c.grays.dark_text, bg = "NONE" })
  hl(0, "qfFilename", { fg = c.blues.primary, bg = "NONE" })
  hl(0, "qfLineNr", { fg = c.oranges.text, bg = "NONE" })
  ...
  -- Treesitter
  hl(0, "@comment", { fg = c.tokens.comment, bg = 'NONE', italic = true, })
  ...
  hl(0, "@parameter", { fg = c.oranges.text, bg = 'NONE' })
  hl(0, "@variable.parameter", { fg = c.oranges.text, bg = 'NONE' })
  ...
  hl(0, "@field", { fg = c.blues.text, bg = 'NONE' })
  hl(0, "@property", { fg = c.blues.text, bg = 'NONE' })
  hl(0, "@variable.member", { fg = c.blues.text, bg = 'NONE' })
  hl(0, "@variable", { link = 'Variable' })
  hl(0, "@variable.builtin", { fg = c.blues.text_light, bg = 'NONE' })
  hl(0, "@constant", { link = 'Constant' })
  hl(0, "@constant.builtin", { fg = c.blues.primary, bg = 'NONE' })
  ...
  hl(0, "@tag", { link = 'Tag' })
  hl(0, "@tag.attribute", { fg = c.blues.text, bg = 'NONE', italic = true })
  hl(0, "@tag.delimiter", { fg = c.grays.dark_text, bg = 'NONE' })
  ...
  hl(0, "LspCodeLens", { fg = c.grays.light_text, bg = 'NONE', italic = true })
  hl(0, "LspCodeLensSeparator", { fg = c.grays.light_text, bg = 'NONE', italic = true })

  -- LSP
  hl(0, "LspInlayHint", { fg = c.indent_active, bg = 'NONE' })
  hl(0, "DiagnosticUnnecessary", { fg = c.grays.light_text, bg = 'NONE' })
  ...
  hl(0, "MatchWord", { fg = 'NONE', bg = c.blues.highlight })
  hl(0, "MatchWordCur", { fg = 'NONE', bg = c.blues.highlight })
  hl(0, "MatchParen", { fg = 'NONE', bg = c.blues.highlight })
  hl(0, "MatchParenCur", { fg = 'NONE', bg = c.blues.highlight })
  ...
  -- Telescope
  hl(0, "TelescopeSelection", { fg = c.bg, bg = c.select })
  hl(0, "TelescopeSelectionCaret", { fg = c.bg, bg = c.select })
  hl(0, "TelescopeMatching", { fg = c.blues.text_light, bg = 'NONE', bold = true, italic = true, })
  hl(0, "TelescopeBorder", { fg = c.window.border, bg = c.window.bg })
  hl(0, "TelescopeNormal", { fg = c.window.fg, bg = c.window.bg })
  hl(0, "TelescopePromptTitle", { fg = c.blues.text, bg = 'NONE' })
  hl(0, "TelescopePromptPrefix", { fg = c.window.fg, bg = 'NONE' })
  hl(0, "TelescopeResultsTitle", { fg = c.blues.text, bg = 'NONE' })
  hl(0, "TelescopePreviewTitle", { fg = c.blues.text, bg = 'NONE' })
  ...
  -- Cmp
  hl(0, "CmpItemAbbrDeprecated", { fg = c.grays.light_text, bg = 'NONE', strikethrough = true })
  hl(0, "CmpItemAbbr", { fg = c.window.fg, bg = 'NONE' })
  hl(0, "CmpItemAbbrMatch", { fg = c.blues.text, bg = 'NONE' })
  ...
  hl(0, "CmpItemKind", { fg = c.blues.text_light, bg = 'NONE' })
  -- Functions/Methods - purple (like VS Code)
  ...
  hl(0, "CmpItemKindClass", { fg = c.blues.primary, bg = 'NONE' })
  hl(0, "CmpItemKindEnum", { fg = c.blues.primary, bg = 'NONE' })
  hl(0, "CmpItemKindInterface", { fg = c.blues.primary, bg = 'NONE' })
  hl(0, "CmpItemKindStruct", { fg = c.blues.primary, bg = 'NONE' })
  hl(0, "CmpItemKindTypeParameter", { fg = c.blues.primary, bg = 'NONE' })
  -- Variables/Fields - light blue
  hl(0, "CmpItemKindVariable", { fg = c.blues.text, bg = 'NONE' })
  hl(0, "CmpItemKindField", { fg = c.blues.text, bg = 'NONE' })
  hl(0, "CmpItemKindProperty", { fg = c.blues.text, bg = 'NONE' })
  hl(0, "CmpItemKindEnumMember", { fg = c.blues.text_light, bg = 'NONE' })
  -- Constants - orange
  hl(0, "CmpItemKindConstant", { fg = c.oranges.text, bg = 'NONE' })
  -- Keywords - red/conditional color
  ...
  -- Values
  hl(0, "CmpItemKindValue", { fg = c.oranges.text, bg = 'NONE' })
  hl(0, "CmpItemKindUnit", { fg = c.oranges.text, bg = 'NONE' })
  -- Text/Snippets - green (strings)
  hl(0, "CmpItemKindText", { fg = c.greens.text_light, bg = 'NONE' })
  hl(0, "CmpItemKindSnippet", { fg = c.greens.primary, bg = 'NONE' })
  -- Files/Folders - gray
  hl(0, "CmpItemKindFile", { fg = c.grays.dark_text, bg = 'NONE' })
  hl(0, "CmpItemKindFolder", { fg = c.grays.dark_text, bg = 'NONE' })
  -- Events - yellow
  ...
  -- Lazy
  hl(0, "LazyButton", { fg = c.blues.text_active, bg = c.grays.dark_bg })
  hl(0, "LazyButtonActive", { fg = c.blues.primary, bg = c.window.bg })
  hl(0, "LazyComment", { link = 'Comment' })
  -- hl(0, "LazyCommit", { fg = c.orange, bg = 'NONE' })
  -- hl(0, "LazyCommitIssue", { fg = c.blue_1, bg = 'NONE' })
  hl(0, "LazyH1", { fg = c.blues.primary, bg = c.window.bg, bold = true, })
  ...
  -- NOTE: FoldColumn defined earlier in editor section
